package au.com.nab.mainservice.aop;
...
public class LoggingAspect {
    private static final Logger LOGGER = LoggerFactory.getLogger(au.com.nab.mainservice.aop.LoggingAspect.class);

    @Around("within(au.com.nab.mainservice.service..*)")
