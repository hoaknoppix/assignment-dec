package au.com.nab.voucheradapter.aop;
...
public class LoggingAspect {
    private static final Logger LOGGER = LoggerFactory.getLogger(au.com.nab.voucheradapter.aop.LoggingAspect.class);

    @Around("within(au.com.nab.voucheradapter.service..*)")
